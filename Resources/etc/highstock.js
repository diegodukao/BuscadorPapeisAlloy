(function() {
    ...
    function F(a, b, c) {
        var d, e;
        if (pa(b)) s(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (s(b) && ea(b)) for (d in b) a.setAttribute(d, b[d]);
        return e;
    }
    function ka(a) {
        return Wa(a) ? a : [ a ];
    ...
    function H(a, b) {
        Pa && b && b.opacity !== v && (b.filter = "alpha(opacity=" + b.opacity * 100 + ")");
        y(a.style, b);
    }
    ...
    function Qa(a, b, c, d) {
        ...
        return e + (g ? a.substr(0, g) + d : "") + a.substr(g).replace(/(\d{3})(?=\d)/g, "$1" + d) + (b ? c + U(f - a).toFixed(b).slice(2) : "");
    }
    function Da(a, b) {
    ...
    function vb(a, b) {
        var c = b || [ [ fb, [ 1, 2, 5, 10, 20, 25, 50, 100, 200, 500 ] ], [ Xa, [ 1, 2, 5, 10, 15, 30 ] ], [ Ra, [ 1, 2, 5, 10, 15, 30 ] ], [ ra, [ 1, 2, 3, 4, 6, 8, 12 ] ], [ da, [ 1, 2 ] ], [ Ea, [ 1, 2 ] ], [ Fa, [ 1, 2, 3, 4, 6 ] ], [ ma, null ] ], d = c[c.length - 1], e = G[d[0]], f = d[1], g;
    ...
    function Ya(a, b, c, d) {
        ...
        if (s(b)) {
            j >= G[Xa] && (i.setMilliseconds(0), i.setSeconds(j >= G[Ra] ? 0 : k * W(i.getSeconds() / k)));
            j >= G[Ra] && i[Kb](j >= G[ra] ? 0 : k * W(i[wb]() / k));
            j >= G[ra] && i[Lb](j >= G[da] ? 0 : k * W(i[xb]() / k));
            j >= G[da] && i[yb](j >= G[Fa] ? 1 : k * W(i[Ga]() / k));
            j >= G[Fa] && (i[Mb](j >= G[ma] ? 0 : k * W(i[gb]() / k)), h = i[hb]());
            j >= G[ma] && (h -= h % k, i[Nb](h));
            j === G[Ea] && i[yb](i[Ga]() - i[zb]() + n(d, 1));
            b = 1;
            h = i[hb]();
            for (var d = i.getTime(), l = i[gb](), m = i[Ga](), i = g ? 0 : (86400000 + i.getTimezoneOffset() * 60000) % 86400000; d < c; ) e.push(d), j === G[ma] ? d = ib(h + b * k, 0) : j === G[Fa] ? d = ib(h, l + b * k) : !!g || j !== G[da] && j !== G[Ea] ? (d += j * k, j <= G[ra] && d % G[da] === i && (f[d] = da)) : d = ib(h, l, m + b * k * (j === G[da] ? 1 : 7)), b++;
            e.push(d);
        }
        e.info = y(a, {
            higherRanks: f,
    ...
    G = ha(fb, 1, Xa, 1000, Ra, 60000, ra, 3600000, da, 86400000, Ea, 604800000, Fa, 2678400000, ma, 31556952000);
    Fb = {
        init: function(a, b, c) {
    ...
    N && N.init.call(N, Fb);
    var ob = E.adapterRun, cc = E.getScript, dc = E.inArray, q = E.each, Wb = E.grep, ec = E.offset, Ma = E.map, z = E.merge, C = E.addEvent, O = E.removeEvent, J = E.fireEvent, Xb = E.washMouseEvent, Ib = E.animate, pb = E.stop, E = {
        enabled: !0,
        align: "center",
        x: 0,
        y: 15,
    ...
    Ja.prototype = {
        init: function(a, b) {
            this.element = b === "span" ? X(b) : I.createElementNS(va, b);
            this.renderer = a;
            this.attrSetters = {};
        },
        ...
        attr: function(a, b) {
            ...
            if (pa(a)) c = a, h === "circle" ? c = {
                x: "cx",
                y: "cy"
            }[c] || c : c === "strokeWidth" && (c = "stroke-width"), p = F(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (p = parseFloat(p)); else for (c in a) if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                e !== v && (d = e);
                ...
                } else if (c === "fill") d = i.color(d, g, c); else if (h !== "circle" || c !== "x" && c !== "y") if (h === "rect" && c === "r") F(g, {
                    rx: d,
                    ry: d
                }), j = !0; else if (c === "translateX" || c === "translateY" || c === "rotation" || c === "verticalAlign") j = o = !0; else if (c === "stroke") d = i.color(d, g, c); else if (c === "dashstyle") {
                    if (c = "stroke-dasharray", d = d && d.toLowerCase(), d === "solid") d = Y; else if (d) {
                ...
                } else c === "isTracker" ? this[c] = d : c === "width" ? d = A(d) : c === "align" ? (c = "text-anchor", d = {
                    left: "start",
                    center: "middle",
                    right: "end"
                }[d]) : c === "title" && (e = g.getElementsByTagName("title")[0], e || (e = I.createElementNS(va, "title"), g.appendChild(e)), e.textContent = d); else c = {
                    x: "cx",
                    y: "cy"
                }[c] || c;
                c === "strokeWidth" && (c = "stroke-width");
                c === "stroke-width" && d === 0 && (lb || i.forExport) && (d = 0.000001);
                this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)/.test(c) && (m || (this.symbolAttr(a), m = !0), j = !0);
                if (l && /^(width|height|visibility|x|y|d|transform)$/.test(c)) for (e = l.length; e--; ) F(l[e], c, c === "height" ? w(d - (l[e].cutHeight || 0), 0) : d);
                (c === "width" || c === "height") && h === "rect" && d < 0 && (d = 0);
                this[c] = d;
        ...
        css: function(a) {
            ...
            aa && b && delete a.width;
            if (Pa && !ja) b && delete a.width, H(this.element, a); else {
        ...
        on: function(a, b) {
            wa && a === "click" && (this.element.ontouchstart = function(a) {
                a.preventDefault();
                b();
            });
            this.element["on" + a] = b;
        ...
        htmlGetBBox: function() {
            ...
            if (!b) {
                a.nodeName === "text" && (a.style.position = "absolute");
                b = this.bBox = {
                    x: a.offsetLeft,
                    y: a.offsetTop,
                    width: a.offsetWidth,
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    k = {};
                    if (M !== this.cTT) {
                        s(j) && (a.isSVG ? (r = Pa ? "-ms-transform" : lb ? "-webkit-transform" : mb ? "MozTransform" : Ub ? "-o-transform" : "", k[r] = k.transform = "rotate(" + j + "deg)") : (o = j * kb, p = ba(o), o = fa(o), k.filter = j ? [ "progid:DXImageTransform.Microsoft.Matrix(M11=", p, ", M12=", -o, ", M21=", o, ", M22=", p, ", sizingMethod='auto expand')" ].join("") : Y), H(b, k));
                        k = n(this.elemWidth, b.offsetWidth);
                        l = n(this.elemHeight, b.offsetHeight);
                        k > m && /[ \-]/.test(b.textContent || b.innerText) && (H(b, {
                            width: m + "px",
                            display: "block",
                            whiteSpace: "normal"
                        }), k = m);
        ...
        getBBox: function() {
            ...
            if (!a) {
                ...
                if (b.isSVG) {
                    b = a.width;
                    c = a.height;
                    Pa && e && e.fontSize === "11px" && c === 22.700000762939453 && (a.height = c = 14);
                    d && (a.width = U(c * fa(f)) + U(b * ba(f)), a.height = U(c * ba(f)) + U(b * fa(f)));
                }
                this.bBox = a;
            }
            return a;
        ...
        add: function(a) {
            ...
            g && (c.handleZ = !0, g = A(g));
            if (c.handleZ) for (c = 0; c < e.length; c++) if (a = e[c], b = F(a, "zIndex"), a !== f && (A(b) > g || !s(g) && s(b))) {
                d.insertBefore(f, a);
                h = !0;
                break;
            }
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    c && (F(f, "height", w(F(f, "height") - h, 0)), f.cutHeight = h);
    ...
    oa.prototype = {
        ...
        init: function(a, b, c, d) {
            ...
            this.setSize(b, c, !1);
            var g;
            mb && a.getBoundingClientRect && (this.subPixelFix = b = function() {
                H(a, {
                    left: 0,
                    top: 0
                });
        ...
        buildText: function(a) {
            for (var b = a.element, c = n(a.textStr, "").toString().replace(/<(b|strong)>/g, "<span style=\"font-weight:bold\">").replace(/<(i|em)>/g, "<span style=\"font-style:italic\">").replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), d = b.childNodes, e = /style="([^"]+)"/, f = /href="([^"]+)"/, g = F(b, "x"), h = a.styles, i = h && h.width && A(h.width), j = h && h.lineHeight, k, h = d.length, l = []; h--; ) b.removeChild(d[h]);
            ...
            q(c, function(c, d) {
                ...
                q(h, function(c) {
                    if (c !== "" || h.length === 1) {
                        ...
                        e.test(c) && (q = c.match(e)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), F(n, "style", q));
                        ...
                        if (!t) {
                            if (d) {
                                ...
                                if (!r || isNaN(r)) {
                                    var D;
                                    (D = j) || (D = k.offsetHeight) || (l[d] = b.getBBox ? b.getBBox().height : a.renderer.fontMetrics(b.style.fontSize).h, D = x(l[d] - (l[d - 1] || 0)) || 18);
                                    r = D;
                                }
                                F(n, "dy", r);
                            }
                        ...
                        b.appendChild(n);
                        t++;
                        if (i) for (var c = c.replace(/([^\^])-/g, "$1- ").split(" "), B = []; c.length || B.length; ) delete a.bBox, D = a.getBBox().width, m = D > i, !m || c.length === 1 ? (c = B, B = [], c.length && (n = I.createElementNS(va, "tspan"), F(n, {
                            dy: j || 16,
                            x: g
        ...
        button: function(a, b, c, d, e, f, g) {
            var h = this.label(a, b, c), i = 0, j, k, l, m, o, a = {
                ...
                x2: 0,
                y2: 1
            }, e = z(ha(Hb, 1, "stroke", "#999", "fill", ha("linearGradient", a, "stops", [ [ 0, "#FFF" ], [ 1, "#DDD" ] ]), "r", 3, "padding", 3, "style", ha("color", "black")), e);
            l = e.style;
            delete e.style;
        ...
        symbols: {
            ...
            arc: function(a, b, c, d, e) {
                var f = e.start, c = e.r || c || d, g = e.end - 0.000001, d = e.innerR, h = e.open, i = ba(f), j = fa(f), k = ba(g), g = fa(g), e = e.end - f < La ? 0 : 1;
                return [ "M", a + c * i, b + c * j, "A", c, c, 0, e, 1, a + c * k, b + c * g, h ? "M" : "L", a + d * k, b + d * g, "A", d, d, 0, e, 0, a + d * i, b + d * j, h ? "" : "Z" ];
            }
        },
        clipRect: function(a, b, c, d) {
            var e = "highcharts-" + Eb++, f = this.createElement("clipPath").attr({
                id: e
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                if (Jb) {
                    r || (a = h ? -eb : 0, p.box = r = d ? o.symbol(d, -M * u, a, p.width, p.height) : o.rect(-M * u, a, p.width, p.height, 0, qb[Hb]), r.add(p));
                    r.attr(z({
                        width: p.width,
                        height: p.height
                    }, qb));
            ...
            var o = this, p = o.g(i), t = o.text("", 0, 0, g).attr({
                zIndex: 1
            }), r, n, M = 0, u = 3, w, D, B, Z, Yb = 0, qb = {}, eb, g = p.attrSetters, Jb;
            C(p, "add", m);
            g.width = function(a) {
                w = a;
                return !1;
            ...
            return y(p, {
                css: function(a) {
                    if (a) {
                        var b = {}, a = z({}, a);
                        q("fontSize,fontWeight,fontFamily,color,lineHeight,width".split(","), function(c) {
    ...
    if (!ja && !aa) {
        var ca = {
            init: function(a, b) {
                ...
                c.push(" style=\"", d.join(""), "\"/>");
                b && (c = b === na || b === "span" || b === "img" ? c.join("") : a.prepVML(c), this.element = X(c));
                this.renderer = a;
                this.attrSetters = {};
            },
            add: function(a) {
            ...
            attr: function(a, b) {
                ...
                pa(a) && s(b) && (c = a, a = {}, a[c] = b);
                if (pa(a)) c = a, p = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c]; else for (c in a) if (d = a[c], m = !1, e = o[c] && o[c].call(this, d, c), e !== !1 && d !== null) {
                    e !== v && (d = e);
                    if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c)) k || (this.symbolAttr(a), k = !0), m = !0; else if (c === "d") {
                        ...
                        g[c] = d;
                        m = !0;
                    } else c === "zIndex" ? (d && (g[c] = d), m = !0) : c === "width" || c === "height" ? (d = w(0, d), this[c] = d, this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, m = !0) : c === "x" || c === "y" ? (this[c] = d, g[{
                        x: "left",
                        y: "top"
                    }[c]] = d) : c === "class" ? f.className = d : c === "stroke" ? (d = i.color(d, f, c), c = "strokecolor") : c === "stroke-width" || c === "strokeWidth" ? (f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, Ba(d) && (d += "px")) : c === "dashstyle" ? ((f.getElementsByTagName("stroke")[0] || X(i.prepVML([ "<stroke/>" ]), null, null, f))[c] = d || "solid", this.dashstyle = d, m = !0) : c === "fill" ? h === "SPAN" ? g.color = d : h !== "IMG" && (f.filled = d !== Y ? !0 : !1, d = i.color(d, f, c, this), c = "fillcolor") : h === "shape" && c === "rotation" ? (this[c] = d, f.style.left = -x(fa(d * kb) + 1) + "px", f.style.top = x(ba(d * kb)) + "px") : c === "translateX" || c === "translateY" || c === "rotation" ? (this[c] = d, this.updateTransform(), m = !0) : c === "text" && (this.bBox = null, f.innerHTML = d, m = !0);
                    m || (cb ? f[c] = d : F(f, c, d));
                }
                return p;
            },
            ...
            init: function(a, b, c) {
                ...
                this.boxWrapper = d;
                this.setSize(b, c, !1);
                I.namespaces.hcv || (I.namespaces.add("hcv", "urn:schemas-microsoft-com:vml"), I.createStyleSheet().cssText = "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } ");
            },
            isHidden: function() {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    var k, l, m = a.linearGradient || a.radialGradient, o, p, t, r, n, M = "", a = a.stops, u, v = [], D = function() {
                        h = [ "<fill colors=\"" + v.join(",") + "\" opacity=\"", t, "\" o:opacity2=\"", p, "\" type=\"", i, "\" ", M, "focus=\"100%\" method=\"any\" />" ];
                    ...
                    if (c === "fill") if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, M = "angle=\"" + (90 - L.atan((m - a) / (o - c)) * 180 / La) + "\"", D(); else {
                        var j = m.r, B = j * 2, Z = j * 2, s = m.cx, w = m.cy, x = b.radialReference, z, j = function() {
                ...
                } else if (g.test(a) && b.tagName !== "IMG") f = ya(a), h = [ "<", c, " opacity=\"", f.get("a"), "\"/>" ], X(this.prepVML(h), null, null, b), j = f.get("rgb"); else {
            ...
            rect: function(a, b, c, d, e, f) {
                ea(a) && (b = a.y, c = a.width, d = a.height, f = a.strokeWidth, a = a.x);
    ...
    ab.prototype = {
        addLabel: function() {
            ...
            if (s(e)) e && e.attr({
                ...
                Ba(g.rotation) && (d.rotation = g.rotation);
        ...
        getLabelPosition: function(a, b, c, d, e, f, g, h) {
            ...
            s(e.y) || (b += A(c.styles.lineHeight) * 0.9 - c.getBBox().height / 2);
            i && (b += g / (h || 1) % i * 16);
            return {
                x: a,
                y: b
        ...
        render: function(a, b) {
            var c = this.axis, d = c.options, e = c.chart.renderer, f = c.horiz, g = this.type, h = this.label, i = this.pos, j = d.labels, k = this.gridLine, l = g ? g + "Grid" : "grid", m = g ? g + "Tick" : "tick", o = d[l + "LineWidth"], p = d[l + "LineColor"], t = d[l + "LineDashStyle"], r = d[m + "Length"], l = d[m + "Width"] || 0, q = d[m + "Color"], M = d[m + "Position"], m = this.mark, u = j.step, s = !0, D = c.tickmarkOffset, B = this.getPosition(f, i, D, b), Z = B.x, B = B.y, w = c.staggerLines;
            if (o) {
            ...
            l && r && (M === "inside" && (r = -r), c.opposite && (r = -r), g = this.getMarkPath(Z, B, r, l, f, e), m ? m.animate({
                d: g
            }) : this.mark = e.path(g).attr({
                stroke: q,
                "stroke-width": l
            }).add(c.axisGroup));
            h && !isNaN(Z) && (h.xy = B = this.getLabelPosition(Z, B, h, f, j, D, a, u), this.isFirst && !n(d.showFirstLabel, 1) || this.isLast && !n(d.showLastLabel, 1) ? s = !1 : !w && f && j.overflow === "justify" && !this.handleOverflow(a, B) && (s = !1), u && a % u && (s = !1), s ? (h[this.isNew ? "attr" : "animate"](B), this.isNew = !1) : h.attr("y", -9999));
        },
        destroy: function() {
            ta(this, this.axis);
        }
    ...
    Ab.prototype = {
        render: function() {
            var a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2, e = a.options, f = e.label, g = a.label, h = e.width, i = e.to, j = e.from, k = s(j) && s(i), l = e.value, m = e.dashStyle, o = a.svgElem, p = [], t, r = e.color, q = e.zIndex, M = e.events, u = b.chart.renderer;
            ...
            if (o) p ? o.animate({
                ...
                o.show();
            }); else if (p && p.length && (a.svgElem = o = u.path(p).attr(d).add(), M)) for (t in e = function(b) {
                o.on(b, function(c) {
                    M[b].apply(a, [ c ]);
                });
            }, M) e(t);
            if (f && s(f.text) && p && p.length && b.width > 0 && b.height > 0) {
                ...
                g || (a.label = g = u.text(f.text, 0, 0).attr({
        ...
        destroy: function() {
            Ca(this.axis.plotLinesAndBands, this);
            ta(this, this.axis);
        }
    };
    Rb.prototype = {
        ...
        setOffset: function(a, b) {
            var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g = c.translate(this.percent ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0), c = U(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {
                x: e ? f ? g : g - c : h,
    ...
    Ta.prototype = {
        ...
        init: function(a, b) {
            ...
            this.isLog && (this.val2lin = qa, this.lin2val = ia);
        },
        ...
        defaultLabelFormatter: function() {
            ...
            if (a.categories) f = b; else if (c) f = xa(c, b); else if (e && g >= 1000) for (; e-- && f === v; ) a = Math.pow(1000, e + 1), g >= a && d[e] !== null && (f = Qa(b / a, -1) + d[e]);
            f === v && (f = b >= 1000 ? Qa(b, 0) : Qa(b, -1));
            return f;
        },
        getSeriesExtremes: function() {
            ...
            q(a.series, function(g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    var h = g.options, i, j, k, l, m, o, p, t, r, q = h.threshold, M, u = [], x = 0;
                    a.hasVisibleSeries = !0;
                    a.isLog && q <= 0 && (q = h.threshold = null);
                    if (a.isXAxis) {
                        ...
                        i && (m = h.stack, l = g.type + n(m, ""), o = "-" + l, g.stackKey = l, j = d[l] || [], d[l] = j, k = e[o] || [], e[o] = k);
                        a.usePercentage && (a.dataMin = 0, a.dataMax = 99);
                        h = g.processedXData;
                        p = g.processedYData;
                        M = p.length;
                        for (f = 0; f < M; f++) if (t = h[f], r = p[f], i && (B = (D = r < q) ? k : j, Z = D ? o : l, s(B[t]) ? (B[t] = la(B[t] + r), r = [ r, B[t] ]) : B[t] = r, c[Z] || (c[Z] = {}), c[Z][t] || (c[Z][t] = new Rb(a, a.options.stackLabels, D, t, m, i)), c[Z][t].setTotal(B[t])), r !== null && r !== v && (eb && (r = g.modifyValue(r)), z || (h[f + 1] || t) >= y.min && (h[f - 1] || t) <= y.max)) if (t = r.length) for (; t--; ) r[t] !== null && (u[x++] = r[t]); else u[x++] = r;
                        !a.usePercentage && u.length && (a.dataMin = K(n(a.dataMin, u[0]), Ha(u)), a.dataMax = w(n(a.dataMax, u[0]), sa(u)));
                        s(q) && (a.dataMin >= q ? (a.dataMin = q, a.ignoreMinPadding = !0) : a.dataMax < q && (a.dataMax = q, a.ignoreMaxPadding = !0));
                    }
                }
            });
        },
        ...
        getLogTickPositions: function(a, b, c, d) {
            ...
            if (a >= 0.5) a = x(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08) for (var f = W(b), h, i, j, k, l, e = a > 0.3 ? [ 1, 2, 4 ] : a > 0.15 ? [ 1, 2, 4, 6, 8 ] : [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ]; f < c + 1 && !l; f++) {
                i = e.length;
                for (h = 0; h < i && !l; h++) j = qa(ia(f) * e[h]), j > b && g.push(k), k > c && (l = !0), k = j;
            } else if (b = ia(b), c = ia(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = n(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = ub(a, null, L.pow(10, W(L.log(a) / L.LN10))), g = Ma(this.getLinearTickPositions(a, b, c), qa), !d) this._minorAutoInterval = a / 5;
        ...
        getMinorTickPositions: function() {
            ...
            } else if (this.isDatetimeAxis && a.minorTickInterval === "auto") d = d.concat(Ya(vb(c), this.min, this.max, a.startOfWeek)); else for (b = this.min + (b[0] - this.min) % c; b <= this.max; b += c) d.push(b);
            return d;
        },
        adjustForMinRange: function() {
            var a = this.options, b = this.min, c = this.max, d, e = this.dataMax - this.dataMin >= this.minRange, f, g, h, i, j;
            this.isXAxis && this.minRange === v && !this.isLog && (s(a.min) || s(a.max) ? this.minRange = null : (q(this.series, function(a) {
                i = a.xData;
        ...
        setAxisTranslation: function() {
            ...
            this.isXAxis && (f ? (d = f.minPointOffset, e = f.pointRangePadding) : q(this.series, function(a) {
        ...
        setTickPositions: function(a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = b.options.tickPositioner, j = d.maxPadding, k = d.minPadding, l = d.tickInterval, m = d.minTickInterval, o = d.tickPixelInterval, p = b.categories;
            ...
            e && (!a && K(b.min, n(b.dataMin, b.min)) <= 0 && Za(10, 1), b.min = la(qa(b.min)), b.max = la(qa(b.max)));
            b.range && (b.userMin = b.min = w(b.min, b.max - b.range), b.userMax = b.max, a) && (b.range = null);
            b.adjustForMinRange();
            if (!p && !b.usePercentage && !h && s(b.min) && s(b.max) && (c = b.max - b.min)) {
                !s(d.min) && !s(b.userMin) && k && (b.dataMin < 0 || !b.ignoreMinPadding) && (b.min -= c * k);
                !s(d.max) && !s(b.userMax) && j && (b.dataMax > 0 || !b.ignoreMaxPadding) && (b.max += c * j);
            }
            ...
            !f && !e && (a = L.pow(10, W(L.log(b.tickInterval) / L.LN10)), !l) && (b.tickInterval = ub(b.tickInterval, null, a, d));
            ...
            i || (i = f ? (b.getNonLinearTimeTicks || Ya)(vb(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max), b.tickPositions = i);
            h || (e = i[0], f = i[i.length - 1], h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && i.shift(), d.endOnTick ? b.max = f : b.max + h < f && i.pop(), i.length === 1 && (b.min -= 1e-9, b.max += 1e-9));
        },
        ...
        setExtremes: function(a, b, c, d, e) {
            var f = this, g = f.chart, c = n(c, !0), e = y(e, {
                min: a,
                max: b
            });
        ...
        getOffset: function() {
            ...
            }), a.staggerLines && (p += (a.staggerLines - 1) * 16); else for (ga in f) f[ga].destroy(), delete f[ga];
            if (m && m.text) {
                a.axisTitle || (a.axisTitle = c.text(m.text, 0, 0, m.useHTML).attr({
                    zIndex: 7,
                ...
                i && (j = a.axisTitle.getBBox()[g ? "height" : "width"], l = n(m.margin, g ? 5 : 10), k = m.offset);
        ...
        render: function() {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.stacks, j = a.ticks, k = a.minorTicks, l = a.alternateBands, m = d.stackLabels, o = d.alternateGridColor, p = a.tickmarkOffset, t = d.lineWidth, r, n = b.hasRendered && s(a.oldMin) && !isNaN(a.oldMin), M = a.showAxis, u, w;
            if (a.hasData || f) if (a.minorTickInterval && !a.categories && q(a.getMinorTickPositions(), function(b) {
                ...
                if (!f || b >= a.min && b <= a.max) j[b] || (j[b] = new ab(a, b)), n && j[b].isNew && j[b].render(c, !0), j[b].isActive = !0, j[b].render(c);
            }), o && q(g, function(b, c) {
                c % 2 === 0 && b < a.max && (l[b] || (l[b] = new Ab(a)), u = b + p, w = g[c + 1] !== v ? g[c + 1] + p : a.max, l[b].options = {
                    from: e ? ia(u) : u,
                    to: e ? ia(w) : w,
                    color: o
            ...
            t && (r = a.getLinePath(t), a.axisLine ? a.axisLine.animate({
                d: r
            ...
            h && M && (h[h.isNew ? "attr" : "animate"](a.getTitlePosition()), h.isNew = !1);
            if (m && m.enabled) {
                ...
                for (D in i) for (B in b = i[D], b) b[B].render(d);
            }
            a.isDirty = !1;
        },
    ...
    Bb.prototype = {
        ...
        move: function(a, b, c, d) {
            ...
            e.label.attr(f);
            g && (U(a - f.x) > 1 || U(b - f.y) > 1) && (clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function() {
                e && e.move(a, b, c, d);
            }, 32));
        },
        hide: function() {
        ...
        refresh: function(a, b) {
            ...
            if (o) {
                o = ka(o);
                for (e = o.length; e--; ) if (i = a.series[e ? "yAxis" : "xAxis"], o[e] && i) if (i = i.getPlotLinePath(e ? n(a.stackY, a.y) : a.x, 1), this.crosshairs[e]) this.crosshairs[e].attr({
                    d: i,
                    visibility: "visible"
                }); else {
                    j = {
    ...
    Cb.prototype = {
        ...
        onmousemove: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                e = [];
                h = c.length;
                for (i = 0; i < h; i++) c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints && c[i].tooltipPoints.length && (b = c[i].tooltipPoints[k], b._dist = U(k - b[c[i].xAxis.tooltipPosName || "plotX"]), j = K(j, b._dist), e.push(b));
        ...
        setDOMEvents: function() {
            ...
            var h = function(a) {
                if (!a || !(a.touches && a.touches.length > 1)) {
                    ...
                    d.indexOf("touch") === -1 && (a.returnValue = !1);
                    d === "touchstart" && (F(a.target, "isTracker") ? c.runTrackerClick || a.preventDefault() : !c.runChartClick && !m && a.preventDefault());
                    m && (h < c.plotLeft ? h = c.plotLeft : h > c.plotLeft + c.plotWidth && (h = c.plotLeft + c.plotWidth), l < c.plotTop ? l = c.plotTop : l > c.plotTop + c.plotHeight && (l = c.plotTop + c.plotHeight));
                    if (c.mouseIsDown && d !== "touchstart" && (e = Math.sqrt(Math.pow(b.mouseDownX - h, 2) + Math.pow(b.mouseDownY - l, 2)), e > 10)) {
                        ...
                        c.hasCartesianSeries && (b.zoomX || b.zoomY) && d && !b.selectionMarker && (b.selectionMarker = c.renderer.rect(c.plotLeft, c.plotTop, f ? 1 : c.plotWidth, g ? 1 : c.plotHeight, 0).attr({
            ...
            /Android 4\.0/.test(ua) || (d.onmousemove = h);
            ...
            d.onclick = function(a) {
                ...
                a.cancelBubble = !0;
                c.cancelClick || (d && (F(a.target, "isTracker") || F(a.target.parentNode, "isTracker")) ? (e = d.plotX, f = d.plotY, y(d, {
        ...
        init: function(a, b) {
            ...
            b.enabled && (a.tooltip = new Bb(a, b));
            this.setDOMEvents();
        }
    };
    Db.prototype = {
        ...
        colorizeItem: function(a, b) {
            ...
            if (f) {
                if (g) for (j in g = a.convertAttribs(g), g) d = g[j], d !== v && (i[j] = d);
                f.attr(i);
            }
        },
        ...
        renderItem: function(a) {
            var B, b = this, c = b.chart, d = c.renderer, e = b.options, f = e.layout === "horizontal", g = e.symbolWidth, h = e.symbolPadding, i = b.itemStyle, j = b.itemHiddenStyle, k = b.padding, l = !e.rtl, m = e.width, o = e.itemMarginBottom || 0, p = b.itemMarginTop, t = b.initialItemX, r = a.legendItem, n = a.series || a, q = n.options, u = q.showCheckbox, s = e.useHTML;
            !r && (a.legendGroup = d.g("legend-item").attr({
                zIndex: 1
            ...
            f && b.itemX - t + e > (m || c.chartWidth - 2 * k - t) && (b.itemX = t, b.itemY += p + b.lastLineHeight + o, b.lastLineHeight = 0);
            ...
            b.offsetWidth = m || w(f ? b.itemX - t : e, b.offsetWidth);
        },
        render: function() {
            ...
            if (l || m) {
                g += k;
                h += k;
                i ? g > 0 && h > 0 && (i[i.isNew ? "attr" : "animate"](i.crisp(null, null, null, g, h)), i.isNew = !1) : (a.box = i = c.rect(0, 0, g, h, j.borderRadius, l || 0).attr({
        ...
        scroll: function(a, b) {
            ...
            d > c && (d = c);
            d > 0 && (b !== v && Ia(b, this.chart), this.nav.attr({
                translateX: i,
                translateY: e + 7,
                visibility: "visible"
            }), this.up.attr({
    ...
    bb.prototype = {
        ...
        redraw: function(a) {
            ...
            if (this.hasCartesianSeries) {
                ...
                this.getMargins();
                q(b, function(a) {
                    a.isDirtyExtremes && (a.isDirtyExtremes = !1, m.push(function() {
        ...
        setTitle: function(a, b) {
            ...
            c.chartSubtitleOptions = d = z(d.subtitle, b);
        ...
        getChartSize: function() {
            ...
            this.chartHeight = w(0, n(a.height, this.containerHeight > 19 ? this.containerHeight : 400));
        },
        ...
        getContainer: function() {
            ...
            e = "highcharts-" + Eb++;
            pa(a) && (this.renderTo = a = I.getElementById(a));
            a || Za(13, !0);
            ...
            this.renderer = b.forExport ? new oa(a, c, d, !0) : new Ua(a, c, d);
        ...
        getMargins: function() {
            ...
            this.resetMargins();
            e = this.axisOffset;
            (this.title || this.subtitle) && !s(this.optionsMarginTop) && (l = w(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !l.floating && !l.verticalAlign && l.y || 0)) && (this.plotTop = w(this.plotTop, l + n(k.margin, 15) + b));
            f.display && !m.floating && (r === "right" ? s(i) || (this.marginRight = w(this.marginRight, f.legendWidth - p + o + c)) : r === "left" ? s(h) || (this.plotLeft = w(this.plotLeft, f.legendWidth + p + o + a)) : ga === "top" ? s(g) || (this.plotTop = w(this.plotTop, f.legendHeight + t + o + b)) : ga === "bottom" && !s(j) && (this.marginBottom = w(this.marginBottom, f.legendHeight - t + o + d)));
        ...
        setSize: function(a, b, c) {
            ...
            s(a) && (d.chartWidth = e = w(0, x(a)), d.hasUserSize = !!e);
            s(b) && (d.chartHeight = f = w(0, x(b)));
            H(d.container, {
                width: e + "px",
                height: f + "px"
            });
        ...
        drawChartBox: function() {
            ...
            k && (f ? f.animate(s) : this.plotBackground = b.rect(p, t, n, q, 0).attr({
                fill: k
            }).add().shadow(a.plotShadow));
            l && (h ? h.animate(s) : this.plotBGImage = b.image(l, p, t, n, q).add());
            u ? u.animate({
                width: w.width,
                height: w.height
            }) : this.clipRect = b.clipRect(w);
            m && (g ? g.animate(g.crisp(null, p, t, n, q)) : this.plotBorder = b.rect(p, t, n, q, 0, m).attr({
        ...
        render: function() {
            ...
            d.enabled && !a.credits && (f = d.href, a.credits = c.text(d.text, 0, 0).on("click", function() {
                f && (location.href = f);
            }).attr({
        ...
        destroy: function() {
            ...
            q("title,subtitle,chartBackground,plotBackground,plotBGImage,plotBorder,seriesGroup,clipRect,credits,tracker,scroller,rangeSelector,legend,resetZoomButton,tooltip,renderer".split(","), function(b) {
                var c = a[b];
                c && c.destroy && (a[b] = c.destroy());
            });
            d && (d.innerHTML = "", O(d), f && Sa(d));
    ...
    za.prototype = {
        init: function(a, b, c) {
            ...
            this.pointAttr = {};
            a.options.colorByPoint && (b = a.chart.options.colors, this.color = this.color || b[d.color++], d.wrapColor(b.length));
            a.chart.pointCount++;
            return this;
        },
        applyOptions: function(a, b) {
            ...
            } else typeof a[0] == "string" && (this.name = a[0], this.y = a[1]);
            this.x === v && (this.x = b === v ? c.autoIncrement() : b);
        },
        destroy: function() {
            var a = this.series.chart, b = a.hoverPoints, c;
            a.pointCount--;
            b && (this.setState(), Ca(b, this), !b.length) && (a.hoverPoints = null);
        ...
        select: function(a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {
                ...
                b || q(d.getSelectedPoints(), function(a) {
                    a.selected && a !== c && (a.selected = !1, a.setState(""), a.firePointEvent("unselect"));
                });
            });
        },
        ...
        tooltipFormatter: function(a) {
            ...
            for (i in d) g = d[i], pa(g) && g !== a && (h = (" " + g).split(e), f = {
                point: this,
                series: b
            }[h[1]], h = h[2], f === this && j.hasOwnProperty(h) ? (f = j[h] ? h : "value", f = (c[f + "Prefix"] || "") + Qa(this[h], n(c[f + "Decimals"], -1)) + (c[f + "Suffix"] || "")) : f = f[h], a = a.replace(g, f));
            return a;
        },
        ...
        setState: function(a) {
            ...
            if (!(a === this.state || this.selected && a !== "select" || e[a] && e[a].enabled === !1 || a && (i || g && !h.enabled))) {
                if (this.graphic) e = f && this.graphic.symbolName && l[a].r, this.graphic.attr(z(l[a], e ? {
                    x: b - e,
                    y: c - e,
                    width: 2 * e,
                    height: 2 * e
                } : {})); else {
                    a && h && (e = h.radius, j ? j.attr({
                        x: b - e,
                        y: c - e
    ...
    V.prototype = {
        ...
        addPoint: function(a, b, c, d) {
            ...
            j.push(d.x);
            k.push(o.toYData ? o.toYData.call(d) : d.y);
            m.push(a);
        ...
        remove: function(a, b) {
            ...
            c.isRemoving || (c.isRemoving = !0, J(c, "remove", null, function() {
                c.destroy();
        ...
        processData: function(a) {
            ...
            j.pointRange === null && (this.pointRange = h || 1);
        ...
        translate: function() {
            ...
            for (l = 0; l < h; l++) {
                ...
                c && this.visible && r && r[o] && (t = r[o], o = t.total, t.cum = t = t.cum - p, p = t + p, j && (t = n(b.threshold, f.min)), f.isLog && t <= 0 && (t = null), c === "percent" && (t = o ? t * 100 / o : 0, p = o ? p * 100 / o : 0), k.percentage = o ? k.y * 100 / o : 0, k.total = k.stackTotal = o, k.stackY = p);
        ...
        tooltipHeaderFormatter: function(a) {
            ...
            if (e && !c) for (f in G) if (G[f] >= d.closestPointRange) {
        ...
        drawPoints: function() {
            ...
            if (l.enabled || this._hasPointMarkers) for (f = b.length; f--; ) (g = b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === v || i.enabled, m = c.isInsidePlot(d, e, c.inverted), a && e !== v && !isNaN(e)) ? (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = n(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) ? k.attr({
                ...
                width: 2 * h,
                height: 2 * h
            } : {})) : m && (h > 0 || j) && (g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h).attr(a).add(o)) : k && (g.graphic = k.destroy());
        },
        ...
        getAttribs: function() {
            ...
            a.options.marker ? (d.radius = d.radius || b.radius + 2, d.lineWidth = d.lineWidth || b.lineWidth + 1) : d.color = d.color || ya(d.color || f).brighten(d.brightness).get();
            ...
            for (f = h.length; f--; ) {
                ...
                if (e) {
                    ...
                    c = b.states || {};
                    e = c.hover = c.hover || {};
                    a.options.marker || (e.color = ya(e.color || g.color).brighten(e.brightness || d.brightness).get());
        ...
        alignDataLabel: function(a, b, c, d, e) {
            var f = this.chart, g = f.inverted, h = n(a.plotX, -999), a = n(a.plotY, -999), i = b.getBBox(), d = y({
                x: g ? f.plotWidth - a : h,
        ...
        invertGroups: function() {
            function a() {
                ...
                q([ "group", "trackerGroup", "markerGroup" ], function(c) {
        ...
        setState: function(a) {
            ...
            this.state !== a && (this.state = a, d[a] && d[a].enabled === !1 || (a && (b = d[a].lineWidth || b + 1), c && !c.dashstyle && c.attr({
                "stroke-width": b
            }, a ? 0 : 500)));
        },
        setVisible: function(a, b) {
            ...
            e && e[i]();
            h && h[i]();
            if (f) f[i](); else if (j) for (e = j.length; e--; ) (f = j[e], f.tracker) && f.tracker[i]();
            c.hoverSeries === this && this.onMouseOut();
            g && g[i]();
        ...
        drawTracker: function() {
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.renderer, h = f.options.tooltip.snap, i = a.tracker, j = b.cursor, j = j && {
                cursor: j
            }, k = a.singlePoints, l = this.isCartesian && this.plotGroup("trackerGroup", null, "visible", b.zIndex || 1, f.trackerGroup), m, o = function() {
    ...
    ca = $(V, {
        ...
        getPointSpline: function(a, b, c) {
            ...
            if (f && g) {
                ...
                i += l;
                k += l;
                i > a && i > e ? (i = w(a, e), k = 2 * e - i) : i < a && i < e && (i = K(a, e), k = 2 * e - i);
    ...
    ca = $(V, {
        ...
        translate: function() {
            ...
            c.grouping === !1 ? f = 1 : q(b.series, function(b) {
                var c = b.options;
                b.type === a.type && b.visible && a.options.group === c.group && (c.stacking ? (k = b.stackKey, j[k] === v && (j[k] = f++), l = j[k]) : c.grouping !== !1 && (l = f++), b.columnIndex = l);
            });
            var m = a.points, g = U(g.transA) * (g.ordinalSlope || c.pointRange || g.closestPointRange || 1), o = g * c.groupPadding, p = (g - 2 * o) / f, t = c.pointWidth, r = s(t) ? (p - t) / 2 : p * c.pointPadding, x = n(t, p - 2 * r), M = Ka(w(x, 1 + 2 * e)), u = r + (o + ((i ? f - (a.columnIndex || 0) : a.columnIndex) || 0) * p - g / 2) * (i ? -1 : 1), y = a.translatedThreshold = h.getThreshold(c.threshold), D = n(c.minPointLength, 5);
            q(m, function(c) {
        ...
        drawPoints: function() {
            ...
            q(a.points, function(e) {
                ...
                f !== v && !isNaN(f) && e.y !== null ? (d = e.shapeArgs, g ? (pb(g), g.animate(z(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius)) : g && (e.graphic = g.destroy());
            });
        },
        drawTracker: function() {
            for (var a = this, b = a.chart, c = b.renderer, d, e, f = +(new Date), g = a.options, h = (d = g.cursor) && {
                ...
                b.hoverSeries !== a && F(j, "isTracker") !== f && a.onMouseOver();
                l[c.target._i].onMouseOver();
            }, n = function(b) {
                !g.stickyTracking && (j = b.relatedTarget || b.toElement, F(j, "isTracker") !== f) && a.onMouseOut();
            }; o--; ) if (m = l[o], e = m.tracker, d = m.trackerArgs || m.shapeArgs, k = m.plotY, k = !a.isCartesian || k !== v && !isNaN(k), delete d.strokeWidth, m.y !== null && k) {
                e ? e.attr(d) : (m.tracker = e = c[m.shapeType](d).attr({
                    isTracker: f,
                    fill: Gb,
                    visibility: a.visible ? "visible" : "hidden"
        ...
        alignDataLabel: function(a, b, c, d, e) {
            var f = this.chart, g = f.inverted, h = a.below || a.plotY > n(this.translatedThreshold, f.plotSizeY), i = this.options.stacking || c.inside;
            a.shapeArgs && (d = z(a.shapeArgs), g && (d = {
    ...
    Oa = $(V, {
        ...
        drawTracker: function() {
            for (var a = this, b = a.options.cursor, b = b && {
                ...
                a.onMouseOver();
                b.target._i !== v && c[b.target._i].onMouseOver();
            }; d--; ) if (e = c[d].graphic) e.element._i = d;
            a._hasTracking ? a._hasTracking = !0 : (f.attr({
                isTracker: !0
    ...
    N = {
        ...
        pointClass: $(za, {
            ...
            setVisible: function(a) {
                ...
                !b.isDirty && b.options.ignoreHiddenPoint && (b.isDirty = !0, c.redraw());
            },
                ...
                for (a = p[0][0] && p[0][0].dataLabel && (p[0][0].dataLabel.getBBox().height || 21); w--; ) {
                    ...
                    if (j > 0) {
                        ...
                        for (u = 0; u < y; u++) {
                            ...
                            if (A < u && B[u] !== null) A = u; else for (s < y - u + A && B[u] !== null && (A = s - y + u); B[A] === null; ) A++;
                            v.push({
                                i: A,
                                y: B[A]
                            });
                    ...
                    for (u = 0; u < y; u++) {
                        ...
                        g.moved = !0;
                        o && f && (g = b.connector, h = i ? [ "M", t + (h[6] === "left" ? 5 : -5), r, "C", t, r, 2 * h[2] - h[4], 2 * h[3] - h[5], h[2], h[3], "L", h[4], h[5] ] : [ "M", t + (h[6] === "left" ? 5 : -5), r, "L", h[2], h[3], "L", h[4], h[5] ], g ? (g.animate({
                            d: h
    ...
    N = $(V, N);
    R.pie = N;
    var T = V.prototype, fc = T.processData, gc = T.generatePoints, hc = T.destroy, ic = T.tooltipHeaderFormatter, jc = {
        approximation: "average",
        groupPixelWidth: 2,
        dateTimeLabelFormats: ha(fb, [ "%A, %b %e, %H:%M:%S.%L", "%A, %b %e, %H:%M:%S.%L", "-%H:%M:%S.%L" ], Xa, [ "%A, %b %e, %H:%M:%S", "%A, %b %e, %H:%M:%S", "-%H:%M:%S" ], Ra, [ "%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M" ], ra, [ "%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M" ], da, [ "%A, %b %e, %Y", "%A, %b %e", "-%A, %b %e, %Y" ], Ea, [ "Week from %A, %b %e, %Y", "%A, %b %e", "-%A, %b %e, %Y" ], Fa, [ "%B %Y", "%B", "-%B %Y" ], ma, [ "%Y", "%Y", "-%Y" ])
    }, $b = {
        line: {},
        spline: {},
        area: {},
    ...
    }, ac = [ [ fb, [ 1, 2, 5, 10, 20, 25, 50, 100, 200, 500 ] ], [ Xa, [ 1, 2, 5, 10, 15, 30 ] ], [ Ra, [ 1, 2, 5, 10, 15, 30 ] ], [ ra, [ 1, 2, 3, 4, 6, 8, 12 ] ], [ da, [ 1 ] ], [ Ea, [ 1 ] ], [ Fa, [ 1, 3, 6 ] ], [ ma, null ] ], Aa = {
        sum: function(a) {
            var b = a.length, c;
    ...
    T.groupData = function(a, b, c, d) {
        ...
        for (n = 0; n <= i; n++) {
            for (; c[1] !== v && a[n] >= c[1] || n === i; ) if (j = c.shift(), k = d.apply(0, m), k !== v && (g.push(j), h.push(k)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], n === i) break;
            if (n === i) break;
            if (o) {
                j = this.cropStart + n;
                ...
                var q;
                for (k = 0; k < p; k++) (q = j[o[k]], typeof q == "number") ? m[k].push(q) : q === null && (m[k].hasNulls = !0);
            } else (j = l ? b[n] : null, typeof j == "number") ? m[0].push(j) : j === null && (m[0].hasNulls = !0);
        }
        return [ g, h ];
    };
    T.processData = function() {
        ...
        if (fc.apply(this, arguments) !== !1 && d) {
            ...
            if (j > g / i || j && c.forced) {
                ...
                b.pointRange === null && (this.pointRange = h.info.totalRange);
    ...
    T.tooltipHeaderFormatter = function(a) {
        ...
        if (f && f.options.type === "datetime" && c && Ba(a)) {
            g = this.currentDataGrouping;
            c = c.dateTimeLabelFormats;
            if (g) f = c[g.unitName], g.count === 1 ? d = f[0] : (d = f[1], e = f[2]); else if (!d) for (h in G) if (G[h] >= f.closestPointRange) {
                d = c[h][0];
                break;
            }
            d = xa(d, a);
    ...
    tb(T, "setOptions", function(a, b) {
        ...
        if ($b[d]) {
            Q[d].dataGrouping || (Q[d].dataGrouping = z(jc, $b[d]));
    ...
    N = $(za, {
        applyOptions: function(a) {
            ...
            if (typeof a == "object" && typeof a.length != "number") y(this, a), this.options = a; else if (a.length) {
                if (a.length > f) {
                    typeof a[0] == "string" ? this.name = a[0] : typeof a[0] == "number" && (this.x = a[0]);
                    d++;
                }
                for (; e < f; ) this[c[e++]] = a[d++];
            }
            this.y = this[b.pointValKey];
            this.x === v && b && (this.x = b.autoIncrement());
            return this;
        },
    ...
    N = $(R.column, {
        ...
        getAttribs: function() {
            ...
            var a = this.options, b = a.states, c = a.upColor || this.color, a = z(this.pointAttr), d = this.upColorProp, e = this.points || [], f = e.length;
            a[""][d] = c;
        ...
        translate: function() {
            ...
            q(this.points, function(b) {
                b.open !== null && (b.plotOpen = a.translate(b.open, 0, 1, 0, 1));
                b.close !== null && (b.plotClose = a.translate(b.close, 0, 1, 0, 1));
            });
        },
        drawPoints: function() {
            var a = this, b = a.chart, c, d, e, f, g, h, i, j;
            q(a.points, function(k) {
                k.plotY !== v && (i = k.graphic, c = k.pointAttr[k.selected ? "selected" : ""], f = c["stroke-width"] % 2 / 2, j = x(k.plotX) + f, g = x(k.shapeArgs.width / 2), h = [ "M", j, x(k.yBottom), "L", j, x(k.plotY) ], k.open !== null && (d = x(k.plotOpen) + f, h.push("M", j, d, "L", j - g, d)), k.close !== null && (e = x(k.plotClose) + f, h.push("M", j, e, "L", j + g, e)), i ? i.animate({
                    d: h
    ...
    N = $(N, {
        ...
        drawPoints: function() {
            ...
            q(a.points, function(m) {
                j = m.graphic;
                m.plotY !== v && (c = m.pointAttr[m.selected ? "selected" : ""], h = c["stroke-width"] % 2 / 2, i = x(m.plotX) + h, d = x(m.plotOpen) + h, e = x(m.plotClose) + h, f = L.min(d, e), g = L.max(d, e), l = x(m.shapeArgs.width / 2), k = [ "M", i - l, g, "L", i - l, f, "L", i + l, f, "L", i + l, g, "L", i - l, g, "M", i, g, "L", i, x(m.yBottom), "M", i, f, "L", i, x(m.plotY), "Z" ], j ? j.animate({
                    d: k
    ...
    R.flags = $(R.column, {
        ...
        translate: function() {
            ...
            if (d && d.visible && h) {
                ...
                for (b.sort(function(a, b) {
                    return a.x - b.x;
                }); h-- && b[c]; ) if (d = b[c], k = g[h], k.x <= d.x && k.plotY !== v) {
                    d.x <= l && (d.plotY = k.plotY, k.x < d.x && !f && (m = g[h + 1]) && m.plotY !== v && (d.plotY += (d.x - k.x) / (m.x - k.x) * (m.plotY - k.plotY)));
                    c--;
                    h++;
                    if (c < 0) break;
                }
            ...
            q(b, function(c, d) {
                c.plotY === v && (c.x >= j.min && c.x <= j.max ? c.plotY = i.lineTop - a.plotTop : c.shapeArgs = {});
                if ((e = b[d - 1]) && e.plotX === c.plotX) {
                    e.stackIndex === v && (e.stackIndex = 0);
        ...
        drawPoints: function() {
            ...
            for (k = b.length; k--; ) (l = b[k], d = l.plotX + m, j = l.stackIndex, e = l.plotY, e !== v && (e = l.plotY + g + m - (j !== v && j * f.stackDistance)), i = j ? v : l.plotX + m, o = j ? v : l.plotY, j = l.graphic, a = l.tracker, e !== v) ? (a = l.pointAttr[l.selected ? "select" : ""], j ? j.attr({
                x: d,
                y: e,
                r: a.r,
                anchorX: i,
                ...
                y: e
            })) : j && (l.graphic = j.destroy(), a && a.attr("y", -9999));
        },
        drawTracker: function() {
    ...
    Sb.prototype = {
        ...
        render: function(a, b, c, d) {
            ...
            if (!isNaN(a)) {
                ...
                if (!this.rendered) {
                    ...
                    q && (this.scrollbarGroup = k = f.g().add(), l = s.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({
                        y: -l % 2 / 2,
                ...
                q && (this.drawScrollbarButton(0), this.drawScrollbarButton(1), k.translate(i, x(E + u)), o.attr({
                    ...
                    d: [ "M", v - 3, p / 4, "L", v - 3, 2 * p / 3, "M", v, p / 4, "L", v, 2 * p / 3, "M", v + 3, p / 4, "L", v + 3, 2 * p / 3 ],
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                var d = b.tracker.normalizeMouseEvent(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, i = a.scrollbarHeight, k = a.scrollerLeft, o = a.scrollerWidth, p = a.navigatorLeft, n = a.navigatorWidth, q = a.scrollbarPad, r = a.range, t = d.chartX, s = d.chartY, u = b.xAxis[0], v = nb ? 10 : 7;
                if (s > h && s < h + g + i) if ((h = !a.scrollbarEnabled || s < h + g) && L.abs(t - e - p) < v) a.grabbedLeft = !0, a.otherHandlePos = f; else if (h && L.abs(t - f - p) < v) a.grabbedRight = !0, a.otherHandlePos = e; else if (t > p + e - q && t < p + f + q) {
                    a.grabbedCenter = t;
                    b.renderer.isSVG && (m = l.cursor, l.cursor = "ew-resize");
                    j = t - e;
                } else if (t > k && t < k + o && (f = h ? t - p - r / 2 : t < p ? e - K(10, r) : t > k + o - i ? e + K(10, r) : t < p + e ? e - r : f, f < 0 ? f = 0 : f + r > n && (f = n - r), f !== e)) {
                    a.fixedWidth = r;
                    u.ordinalPositions || (u.fixedRange = u.max - u.min);
                    e = c.translate(f, !0);
                    u.setExtremes(e, u.fixedRange ? e + u.fixedRange : c.translate(f + r, !0), !0, !1, {
                        trigger: "navigator"
                    });
                }
            ...
            a.mouseMoveHandler = function(c) {
                ...
                c.pageX !== 0 && (c = b.tracker.normalizeMouseEvent(c), c = c.chartX, c < e ? c = e : c > g + h - d && (c = g + h - d), a.grabbedLeft ? (k = !0, a.render(0, 0, c - e, a.otherHandlePos)) : a.grabbedRight ? (k = !0, a.render(0, 0, a.otherHandlePos, c - e)) : a.grabbedCenter && (k = !0, c < j ? c = j : c > f + j - i && (c = f + j - i), a.render(0, 0, c - j, c - j + i)));
            };
            ...
            a.updatedDataHandler = function() {
                ...
                k = f >= j[j.length - 1];
                j = e <= g;
                p || (i.options.pointStart = o.xData[0], i.setData(o.options.data, !1), n = !0);
                j && (m = g, l = m + h);
                k && (l = d, j || (m = w(l - h, i.xData[0])));
    ...
    tb(Ta.prototype, "zoom", function(a, b, c) {
        ...
        this.isXAxis && (g && g.enabled || e && e.enabled) && (f === "x" ? d.resetZoomButton = "blocked" : f === "y" ? h = !1 : f === "xy" && (d = this.previousZoom, s(b) ? this.previousZoom = [ this.min, this.max ] : d && (b = d[0], c = d[1], delete this.previousZoom)));
    ...
    Tb.prototype = {
        clickButton: function(a, b, c) {
            var d = this, e = d.chart, f = d.buttons, g = e.xAxis[0], h = g && g.getExtremes(), i = e.scroller && e.scroller.xAxis, j = i && i.getExtremes && i.getExtremes(), i = j && j.dataMin, j = j && j.dataMax, k = h && h.dataMin, l = h && h.dataMax, i = (s(k) && s(i) ? K : n)(k, i), j = (s(l) && s(j) ? w : n)(l, j), m, o = g && K(h.max, j), h = new Date(o), l = b.type, k = b.count, p, q, r = {
                millisecond: 1,
                second: 1000,
                minute: 60000,
                hour: 3600000,
            ...
            i !== null && j !== null && a !== d.selected && (r[l] ? (p = r[l] * k, m = w(o - p, i)) : l === "month" ? (h.setMonth(h.getMonth() - k), m = w(h.getTime(), i), p = 2592000000 * k) : l === "ytd" ? (h = new Date(j), q = h.getFullYear(), m = q = w(i || 0, Date.UTC(q, 0, 1)), h = h.getTime(), o = K(j || h, h)) : l === "year" ? (h.setFullYear(h.getFullYear() - k), m = w(i, h.getTime()), p = 31536000000 * k) : l === "all" && g && (m = i, o = j), f[a] && f[a].setState(2), g ? setTimeout(function() {
        ...
        init: function(a) {
            ...
            C(a, "load", function() {
                C(a.xAxis[0], "afterSetExtremes", function() {
                    this.fixedRange !== this.max - this.min && (e[b.selected] && !a.renderer.forExport && e[b.selected].setState(0), b.selected = null);
        ...
        drawInput: function(a) {
            ...
            i.onchange = function() {
                ...
                !isNaN(d) && (h && d >= e.dataMin && d <= b.maxInput.HCTime || !h && d <= e.dataMax && d >= b.minInput.HCTime) && c.xAxis[0].setExtremes(h ? d : e.min, h ? e.max : d, v, v, {
                    trigger: "rangeSelectorInput"
                });
            };
        },
        render: function(a, b) {
            var c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && d.options.navigation.buttonOptions, i = g.rangeSelector, j = c.buttons, k = P.lang, l = c.div, l = c.inputGroup, m = i.buttonTheme, o = i.inputEnabled !== !1, n = m && m.states, t = d.plotLeft, r;
            !c.rendered && (c.zoomText = e.text(k.rangeSelectorZoom, t, d.plotTop - 10).css(i.labelStyle).add(), r = t + c.zoomText.getBBox().width + 5, q(c.buttonOptions, function(a, b) {
    ...
    T.init = function() {
        ...
        a && (this.modifyValue = function(b, c) {
    ...
    (function() {
            ...
            if (d && d.options.ordinal && !d.hasOrdinalExtension) {
                ...
                d.lin2val = function(a, b) {
                    ...
                    if (c) {
                        ...
                        if (b) a < 0 ? a = c[0] : a > k ? a = c[k] : (k = W(a), m = a - k); else for (; k--; ) if (l = d * k + e, a >= l) {
                            d = d * (k + 1) + e;
                            m = (a - l) / (d - l);
                            break;
                        }
                ...
                d.getNonLinearTimeTicks = function(a, b, c, e, j, k, l) {
                    ...
                    if (l && a.unitRange <= G[ra]) {
                        o = u.length - 1;
                        for (m = 1; m < o; m++) (new Date(u[m]))[Ga]() !== (new Date(u[m - 1]))[Ga]() && (q[u[m]] = da, r = !0);
                        r && (q[u[0]] = da);
                        a.higherRanks = q;
                    }
                    u.info = a;
                ...
                b.pan = function(a) {
                    ...
                    if (d.options.ordinal && d.series.length) {
                        ...
                        o = b.hoverPoints;
                        var n = d.closestPointRange, i = (i - a) / (d.translationSlope * (d.ordinalSlope || n)), t = {
                            ordinalPositions: d.getExtendedPositions()
                        }, r, n = d.lin2val, s = d.val2lin;
                        t.ordinalPositions ? U(i) > 1 && (o && q(o, function(a) {
                            a.setState();
        ...
        T.getSegments = function() {
            ...
            b.apply(a);
            e && (d = a.segments, q(d, function(b, g) {
