(function() {
    ...
    function I(a, b) {
        Ea && b && b.opacity !== A && (b.filter = "alpha(opacity=" + b.opacity * 100 + ")");
        x(a.style, b);
    }
    ...
    function Ab(a, b) {
        var c = b || [ [ Bb, [ 1, 2, 5, 10, 20, 25, 50, 100, 200, 500 ] ], [ ib, [ 1, 2, 5, 10, 15, 30 ] ], [ Va, [ 1, 2, 5, 10, 15, 30 ] ], [ Ka, [ 1, 2, 3, 4, 6, 8, 12 ] ], [ ma, [ 1, 2 ] ], [ Wa, [ 1, 2 ] ], [ La, [ 1, 2, 3, 4, 6 ] ], [ va, null ] ], d = c[c.length - 1], e = D[d[0]], f = d[1], g;
    ...
    function Cb(a, b, c, d) {
        ...
        if (r(b)) {
            ...
            j >= D[Va] && i[Db](j >= D[Ka] ? 0 : k * U(i[jb]() / k));
            j >= D[Ka] && i[Eb](j >= D[ma] ? 0 : k * U(i[kb]() / k));
            j >= D[ma] && i[lb](j >= D[La] ? 1 : k * U(i[Ma]() / k));
            j >= D[La] && (i[Fb](j >= D[va] ? 0 : k * U(i[Xa]() / k)), h = i[Ya]());
            j >= D[va] && (h -= h % k, i[Gb](h));
            j === D[Wa] && i[lb](i[Ma]() - i[mb]() + n(d, 1));
            b = 1;
            h = i[Ya]();
            for (var d = i.getTime(), l = i[Xa](), m = i[Ma](), i = g ? 0 : (86400000 + i.getTimezoneOffset() * 60000) % 86400000; d < c; ) e.push(d), j === D[va] ? d = Za(h + b * k, 0) : j === D[La] ? d = Za(h, l + b * k) : !!g || j !== D[ma] && j !== D[Wa] ? (d += j * k, j <= D[Ka] && d % D[ma] === i && (f[d] = ma)) : d = Za(h, l, m + b * k * (j === D[ma] ? 1 : 7)), b++;
            e.push(d);
        }
        e.info = x(a, {
            higherRanks: f,
    ...
    var A, C = document, L = window, K = Math, u = K.round, U = K.floor, za = K.ceil, s = K.max, O = K.min, M = K.abs, W = K.cos, Z = K.sin, Aa = K.PI, ab = Aa * 2 / 360, na = navigator.userAgent, Lb = L.opera, Ea = /msie/i.test(na) && !Lb, Ra = C.documentMode === 8, bb = /AppleWebKit/.test(na), cb = /Firefox/.test(na), Mb = /(Mobile|Android|Windows Phone)/.test(na), oa = "http://www.w3.org/2000/svg", ca = !!C.createElementNS && !!C.createElementNS(oa, "svg").createSVGRect, Sb = cb && parseInt(na.split("Firefox/")[1], 10) < 4, V = !ca && !Ea && !!C.createElement("canvas").getContext, Sa, Ba = C.documentElement.ontouchstart !== A, Nb = {}, tb = 0, $a, N, db, Pa, ub, D, pa = function() {}, Ha = [], ga = "div", Q = "none", vb = "rgba(192,192,192," + (ca ? 0.0001 : 0.002) + ")", Bb = "millisecond", ib = "second", Va = "minute", Ka = "hour", ma = "day", Wa = "week", La = "month", va = "year", wb = "stroke-width", Za, jb, kb, mb, Ma, Xa, Ya, Db, Eb, lb, Fb, Gb, $ = {};
    L.Highcharts = {};
    db = function(a, b, c) {
    ...
    D = ia(Bb, 1, ib, 1000, Va, 60000, Ka, 3600000, ma, 86400000, Wa, 604800000, La, 2678400000, va, 31556952000);
    ub = {
        init: function(a, b, c) {
    ...
    (function(a) {
        L.HighchartsAdapter = L.HighchartsAdapter || a && {
            ...
            washMouseEvent: function(a) {
                ...
                c.pageX === A && (c.pageX = a.pageX, c.pageY = a.pageY);
                return c;
            },
    ...
    var eb = G.adapterRun, Tb = G.getScript, Ub = G.inArray, o = G.each, Ob = G.grep, Vb = G.offset, Ta = G.map, B = G.merge, J = G.addEvent, R = G.removeEvent, F = G.fireEvent, Pb = G.washMouseEvent, xb = G.animate, fb = G.stop, G = {
        enabled: !0,
        align: "center",
        x: 0,
        y: 15,
    ...
    ya.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (ja(a)) c = a, h === "circle" ? c = {
                ...
                } else if (c === "fill") d = i.color(d, g, c); else if (h !== "circle" || c !== "x" && c !== "y") if (h === "rect" && c === "r") w(g, {
                    rx: d,
                    ry: d
                }), j = !0; else if (c === "translateX" || c === "translateY" || c === "rotation" || c === "verticalAlign") j = q = !0; else if (c === "stroke") d = i.color(d, g, c); else if (c === "dashstyle") {
                    if (c = "stroke-dasharray", d = d && d.toLowerCase(), d === "solid") d = Q; else if (d) {
                ...
                } else c === "isTracker" ? this[c] = d : c === "width" ? d = z(d) : c === "align" ? (c = "text-anchor", d = {
                    left: "start",
                    center: "middle",
                    right: "end"
                }[d]) : c === "title" && (e = g.getElementsByTagName("title")[0], e || (e = C.createElementNS(oa, "title"), g.appendChild(e)), e.textContent = d); else c = {
                    x: "cx",
                    y: "cy"
                }[c] || c;
                c === "strokeWidth" && (c = "stroke-width");
                c === "stroke-width" && d === 0 && (bb || i.forExport) && (d = 0.000001);
        ...
        css: function(a) {
            ...
            V && b && delete a.width;
            if (Ea && !ca) b && delete a.width, I(this.element, a); else {
        ...
        on: function(a, b) {
            Ba && a === "click" && (this.element.ontouchstart = function(a) {
                a.preventDefault();
                b();
            });
            this.element["on" + a] = b;
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    k = {};
                    if (ra !== this.cTT) {
                        r(j) && (a.isSVG ? (t = Ea ? "-ms-transform" : bb ? "-webkit-transform" : cb ? "MozTransform" : Lb ? "-o-transform" : "", k[t] = k.transform = "rotate(" + j + "deg)") : (q = j * ab, p = W(q), q = Z(q), k.filter = j ? [ "progid:DXImageTransform.Microsoft.Matrix(M11=", p, ", M12=", -q, ", M21=", q, ", M22=", p, ", sizingMethod='auto expand')" ].join("") : Q), I(b, k));
                        k = n(this.elemWidth, b.offsetWidth);
                        l = n(this.elemHeight, b.offsetHeight);
                        k > m && /[ \-]/.test(b.textContent || b.innerText) && (I(b, {
                            width: m + "px",
                            display: "block",
                            whiteSpace: "normal"
                        }), k = m);
        ...
        getBBox: function() {
            ...
            if (!a) {
                ...
                if (b.isSVG) {
                    b = a.width;
                    c = a.height;
                    Ea && e && e.fontSize === "11px" && c === 22.700000762939453 && (a.height = c = 14);
                    d && (a.width = M(c * Z(f)) + M(b * W(f)), a.height = M(c * W(f)) + M(b * Z(f)));
                }
                this.bBox = a;
            }
            return a;
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    c && (w(f, "height", s(w(f, "height") - h, 0)), f.cutHeight = h);
    ...
    sa.prototype = {
                    ...
                    if (c !== "" || h.length === 1) {
                        ...
                        if (!y) {
                            if (d) {
                                ...
                                if (!t || isNaN(t)) {
                                    var r;
                                    (r = j) || (r = k.offsetHeight) || (l[d] = b.getBBox ? b.getBBox().height : a.renderer.fontMetrics(b.style.fontSize).h, r = u(l[d] - (l[d - 1] || 0)) || 18);
                                    t = r;
                                }
                                w(n, "dy", t);
                            }
        ...
        symbols: {
            ...
            arc: function(a, b, c, d, e) {
                var f = e.start, c = e.r || c || d, g = e.end - 0.000001, d = e.innerR, h = e.open, i = W(f), j = Z(f), k = W(g), g = Z(g), e = e.end - f < Aa ? 0 : 1;
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                if (z) {
                    n || (a = h ? -zb : 0, p.box = n = d ? q.symbol(d, -ra * v, a, p.width, p.height) : q.rect(-ra * v, a, p.width, p.height, 0, w[wb]), n.add(p));
                    n.attr(B({
                        width: p.width,
                        height: p.height
                    }, w));
    ...
    if (!ca && !V) {
        ha = {
            init: function(a, b) {
                ...
                c.push(" style=\"", d.join(""), "\"/>");
                b && (c = b === ga || b === "span" || b === "img" ? c.join("") : a.prepVML(c), this.element = T(c));
                this.renderer = a;
                this.attrSetters = {};
            },
            add: function(a) {
            ...
            attr: function(a, b) {
                ...
                if (ja(a)) c = a, p = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c]; else for (c in a) if (d = a[c], m = !1, e = q[c] && q[c].call(this, d, c), e !== !1 && d !== null) {
                    ...
                    if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c)) k || (this.symbolAttr(a), k = !0), m = !0; else if (c === "d") {
                        ...
                        g[c] = d;
                        m = !0;
                    } else c === "zIndex" ? (d && (g[c] = d), m = !0) : c === "width" || c === "height" ? (d = s(0, d), this[c] = d, this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, m = !0) : c === "x" || c === "y" ? (this[c] = d, g[{
                        x: "left",
                        y: "top"
                    }[c]] = d) : c === "class" ? f.className = d : c === "stroke" ? (d = i.color(d, f, c), c = "strokecolor") : c === "stroke-width" || c === "strokeWidth" ? (f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, Da(d) && (d += "px")) : c === "dashstyle" ? ((f.getElementsByTagName("stroke")[0] || T(i.prepVML([ "<stroke/>" ]), null, null, f))[c] = d || "solid", this.dashstyle = d, m = !0) : c === "fill" ? h === "SPAN" ? g.color = d : h !== "IMG" && (f.filled = d !== Q ? !0 : !1, d = i.color(d, f, c, this), c = "fillcolor") : h === "shape" && c === "rotation" ? (this[c] = d, f.style.left = -u(Z(d * ab) + 1) + "px", f.style.top = u(W(d * ab)) + "px") : c === "translateX" || c === "translateY" || c === "rotation" ? (this[c] = d, this.updateTransform(), m = !0) : c === "text" && (this.bBox = null, f.innerHTML = d, m = !0);
                    m || (Ra ? f[c] = d : w(f, c, d));
                }
                return p;
            },
        ...
        var fa = {
            ...
            init: function(a, b, c) {
                ...
                this.boxWrapper = d;
                this.setSize(b, c, !1);
                C.namespaces.hcv || (C.namespaces.add("hcv", "urn:schemas-microsoft-com:vml"), C.createStyleSheet().cssText = "hcv\\:fill, hcv\\:path, hcv\\:shape, hcv\\:stroke{ behavior:url(#default#VML); display: inline-block; } ");
            },
            isHidden: function() {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill") if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, q = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, r = "angle=\"" + (90 - K.atan((m - a) / (q - c)) * 180 / Aa) + "\"", u(); else {
                        var j = m.r, E = j * 2, S = j * 2, x = m.cx, A = m.cy, w = b.radialReference, z, j = function() {
            ...
            rect: function(a, b, c, d, e, f) {
                Y(a) && (b = a.y, c = a.width, d = a.height, f = a.strokeWidth, a = a.x);
    ...
    Qa.prototype = {
        addLabel: function() {
            ...
            if (r(e)) e && e.attr({
                ...
                Da(g.rotation) && (d.rotation = g.rotation);
        ...
        render: function(a, b) {
            ...
            l && t && (r === "inside" && (t = -t), c.opposite && (t = -t), g = this.getMarkPath(S, E, t, l, f, e), m ? m.animate({
                d: g
            }) : this.mark = e.path(g).attr({
                stroke: o,
                "stroke-width": l
            }).add(c.axisGroup));
            h && !isNaN(S) && (h.xy = E = this.getLabelPosition(S, E, h, f, j, u, a, v), this.isFirst && !n(d.showFirstLabel, 1) || this.isLast && !n(d.showLastLabel, 1) ? s = !1 : !x && f && j.overflow === "justify" && !this.handleOverflow(a, E) && (s = !1), v && a % v && (s = !1), s ? (h[this.isNew ? "attr" : "animate"](E), this.isNew = !1) : h.attr("y", -9999));
        },
        destroy: function() {
            Ga(this, this.axis);
        }
    ...
    nb.prototype = {
        render: function() {
            var a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2, e = a.options, f = e.label, g = a.label, h = e.width, i = e.to, j = e.from, k = r(j) && r(i), l = e.value, m = e.dashStyle, q = a.svgElem, p = [], y, t = e.color, o = e.zIndex, u = e.events, v = b.chart.renderer;
            ...
            if (f && r(f.text) && p && p.length && b.width > 0 && b.height > 0) {
                ...
                g || (a.label = g = v.text(f.text, 0, 0).attr({
    ...
    ob.prototype = {
        ...
        init: function(a, b) {
            ...
            this.isLog && (this.val2lin = ka, this.lin2val = aa);
        },
        ...
        defaultLabelFormatter: function() {
            var a = this.axis, b = this.value, c = this.dateTimeLabelFormat, d = N.lang.numericSymbols, e = d && d.length, f, g = a.isLog ? b : a.tickInterval;
            if (a.categories) f = b; else if (c) f = db(c, b); else if (e && g >= 1000) for (; e-- && f === A; ) a = Math.pow(1000, e + 1), g >= a && d[e] !== null && (f = Ja(b / a, -1) + d[e]);
            f === A && (f = b >= 1000 ? Ja(b, 0) : Ja(b, -1));
            return f;
        },
        getSeriesExtremes: function() {
            ...
            o(a.series, function(g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    var h = g.options, i, j, k, l, m, q, p, y, t, o = h.threshold, u, v = [], x = 0;
                    a.hasVisibleSeries = !0;
                    a.isLog && o <= 0 && (o = h.threshold = null);
                    if (a.isXAxis) {
                        ...
                        i && (m = h.stack, l = g.type + n(m, ""), q = "-" + l, g.stackKey = l, j = d[l] || [], d[l] = j, k = e[q] || [], e[q] = k);
                        ...
                        !a.usePercentage && v.length && (a.dataMin = O(n(a.dataMin, v[0]), Fa(v)), a.dataMax = s(n(a.dataMax, v[0]), wa(v)));
                        r(o) && (a.dataMin >= o ? (a.dataMin = o, a.ignoreMinPadding = !0) : a.dataMax < o && (a.dataMax = o, a.ignoreMaxPadding = !0));
                    }
                }
            });
        },
        ...
        getMinorTickPositions: function() {
            ...
            } else if (this.isDatetimeAxis && a.minorTickInterval === "auto") d = d.concat(Cb(Ab(c), this.min, this.max, a.startOfWeek)); else for (b = this.min + (b[0] - this.min) % c; b <= this.max; b += c) d.push(b);
            return d;
        },
        adjustForMinRange: function() {
            var a = this.options, b = this.min, c = this.max, d, e = this.dataMax - this.dataMin >= this.minRange, f, g, h, i, j;
            this.isXAxis && this.minRange === A && !this.isLog && (r(a.min) || r(a.max) ? this.minRange = null : (o(this.series, function(a) {
                i = a.xData;
        ...
        setAxisTranslation: function() {
            ...
            this.isXAxis && (f ? (d = f.minPointOffset, e = f.pointRangePadding) : o(this.series, function(a) {
        ...
        setTickPositions: function(a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = b.options.tickPositioner, j = d.maxPadding, k = d.minPadding, l = d.tickInterval, m = d.minTickInterval, q = d.tickPixelInterval, p = b.categories;
            ...
            e && (!a && O(b.min, n(b.dataMin, b.min)) <= 0 && Oa(10, 1), b.min = da(ka(b.min)), b.max = da(ka(b.max)));
            b.range && (b.userMin = b.min = s(b.min, b.max - b.range), b.userMax = b.max, a) && (b.range = null);
            b.adjustForMinRange();
            if (!p && !b.usePercentage && !h && r(b.min) && r(b.max) && (c = b.max - b.min)) {
                !r(d.min) && !r(b.userMin) && k && (b.dataMin < 0 || !b.ignoreMinPadding) && (b.min -= c * k);
            ...
            !f && !e && (a = K.pow(10, U(K.log(b.tickInterval) / K.LN10)), !l) && (b.tickInterval = hb(b.tickInterval, null, a, d));
            ...
            i || (i = f ? (b.getNonLinearTimeTicks || Cb)(Ab(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max), b.tickPositions = i);
        ...
        render: function() {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.stacks, j = a.ticks, k = a.minorTicks, l = a.alternateBands, m = d.stackLabels, q = d.alternateGridColor, p = a.tickmarkOffset, n = d.lineWidth, t, H = b.hasRendered && r(a.oldMin) && !isNaN(a.oldMin), u = a.showAxis, v, s;
            if (a.hasData || f) if (a.minorTickInterval && !a.categories && o(a.getMinorTickPositions(), function(b) {
                ...
                c % 2 === 0 && b < a.max && (l[b] || (l[b] = new nb(a)), v = b + p, s = g[c + 1] !== A ? g[c + 1] + p : a.max, l[b].options = {
                    from: e ? aa(v) : v,
                    to: e ? aa(s) : s,
                    color: q
            ...
            n && (t = a.getLinePath(n), a.axisLine ? a.axisLine.animate({
                d: t
            ...
            h && u && (h[h.isNew ? "attr" : "animate"](a.getTitlePosition()), h.isNew = !1);
            if (m && m.enabled) {
        ...
        refresh: function(a, b) {
            ...
            if (q) {
                ...
                for (e = q.length; e--; ) if (i = a.series[e ? "yAxis" : "xAxis"], q[e] && i) if (i = i.getPlotLinePath(e ? n(a.stackY, a.y) : a.x, 1), this.crosshairs[e]) this.crosshairs[e].attr({
                    ...
                    q[e].dashStyle && (j.dashstyle = q[e].dashStyle);
    ...
    qb.prototype = {
        ...
        onmousemove: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                e = [];
                h = c.length;
                for (i = 0; i < h; i++) c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints && c[i].tooltipPoints.length && (b = c[i].tooltipPoints[k], b._dist = M(k - b[c[i].xAxis.tooltipPosName || "plotX"]), j = O(j, b._dist), e.push(b));
        ...
        setDOMEvents: function() {
            ...
            /Android 4\.0/.test(na) || (d.onmousemove = h);
            ...
            d.onclick = function(a) {
                ...
                a.cancelBubble = !0;
                c.cancelClick || (d && (w(a.target, "isTracker") || w(a.target.parentNode, "isTracker")) ? (e = d.plotX, f = d.plotY, x(d, {
    ...
    rb.prototype = {
        ...
        positionCheckboxes: function(a) {
            ...
            b && (c = b.translateY, o(this.allItems, function(e) {
                var f = e.checkbox, g;
                f && (g = c + f.y + (a || 0) + 3, I(f, {
        ...
        renderItem: function(a) {
            var p, b = this, c = b.chart, d = c.renderer, e = b.options, f = e.layout === "horizontal", g = e.symbolWidth, h = e.symbolPadding, i = b.itemStyle, j = b.itemHiddenStyle, k = b.padding, l = !e.rtl, m = e.width, q = e.itemMarginBottom || 0, n = b.itemMarginTop, o = b.initialItemX, t = a.legendItem, r = a.series || a, u = r.options, v = u.showCheckbox, x = e.useHTML;
            ...
            f && b.itemX - o + e > (m || c.chartWidth - 2 * k - o) && (b.itemX = o, b.itemY += n + b.lastLineHeight + q, b.lastLineHeight = 0);
        ...
        scroll: function(a, b) {
            ...
            d > c && (d = c);
            d > 0 && (b !== A && xa(b, this.chart), this.nav.attr({
                translateX: i,
                translateY: e + 7,
                visibility: "visible"
            }), this.up.attr({
    ...
    sb.prototype = {
        ...
        redraw: function(a) {
            ...
            if (this.hasCartesianSeries) {
                this.isResizing || (this.maxTicks = null, o(b, function(a) {
                    a.setScale();
                }));
        ...
        getContainer: function() {
            ...
            e = "highcharts-" + tb++;
            ja(a) && (this.renderTo = a = C.getElementById(a));
            a || Oa(13, !0);
        ...
        getMargins: function() {
            ...
            this.resetMargins();
            e = this.axisOffset;
            (this.title || this.subtitle) && !r(this.optionsMarginTop) && (l = s(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !l.floating && !l.verticalAlign && l.y || 0)) && (this.plotTop = s(this.plotTop, l + n(k.margin, 15) + b));
            f.display && !m.floating && (t === "right" ? r(i) || (this.marginRight = s(this.marginRight, f.legendWidth - p + q + c)) : t === "left" ? r(h) || (this.plotLeft = s(this.plotLeft, f.legendWidth + p + q + a)) : u === "top" ? r(g) || (this.plotTop = s(this.plotTop, f.legendHeight + y + q + b)) : u === "bottom" && !r(j) && (this.marginBottom = s(this.marginBottom, f.legendHeight - y + q + d)));
        ...
        setSize: function(a, b, c) {
            ...
            r(a) && (d.chartWidth = e = s(0, u(a)), d.hasUserSize = !!e);
            r(b) && (d.chartHeight = f = s(0, u(b)));
            I(d.container, {
                width: e + "px",
                height: f + "px"
            });
        ...
        drawChartBox: function() {
            ...
            n = i + (a.shadow ? 8 : 0);
            if (i || j) if (e) e.animate(e.crisp(null, null, null, c - n, d - n)); else {
                e = {
                    fill: j || Q
                };
            ...
            k && (f ? f.animate(u) : this.plotBackground = b.rect(p, o, t, r, 0).attr({
                fill: k
            }).add().shadow(a.plotShadow));
            l && (h ? h.animate(u) : this.plotBGImage = b.image(l, p, o, t, r).add());
            v ? v.animate({
                width: s.width,
                height: s.height
            }) : this.clipRect = b.clipRect(s);
            m && (g ? g.animate(g.crisp(null, p, o, t, r)) : this.plotBorder = b.rect(p, o, t, r, 0, m).attr({
    ...
    Ua.prototype = {
        ...
        applyOptions: function(a, b) {
            ...
            this.x === A && (this.x = b === A ? c.autoIncrement() : b);
        },
        destroy: function() {
            var a = this.series.chart, b = a.hoverPoints, c;
            a.pointCount--;
            b && (this.setState(), ta(b, this), !b.length) && (a.hoverPoints = null);
    ...
    P.prototype = {
        ...
        translate: function() {
            ...
            for (l = 0; l < h; l++) {
                ...
                c && this.visible && t && t[q] && (o = t[q], q = o.total, o.cum = o = o.cum - p, p = o + p, j && (o = n(b.threshold, f.min)), f.isLog && o <= 0 && (o = null), c === "percent" && (o = q ? o * 100 / q : 0, p = q ? p * 100 / q : 0), k.percentage = q ? k.y * 100 / q : 0, k.total = k.stackTotal = q, k.stackY = p);
        ...
        drawPoints: function() {
            ...
            if (l.enabled || this._hasPointMarkers) for (f = b.length; f--; ) (g = b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === A || i.enabled, m = c.isInsidePlot(d, e, c.inverted), a && e !== A && !isNaN(e)) ? (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = n(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) ? k.attr({
    ...
    fa = ba(P, {
        ...
        translate: function() {
            ...
            c.grouping === !1 ? f = 1 : o(b.series, function(b) {
                var c = b.options;
                b.type === a.type && b.visible && a.options.group === c.group && (c.stacking ? (k = b.stackKey, j[k] === A && (j[k] = f++), l = j[k]) : c.grouping !== !1 && (l = f++), b.columnIndex = l);
            });
            var m = a.points, g = M(g.transA) * (g.ordinalSlope || c.pointRange || g.closestPointRange || 1), q = g * c.groupPadding, p = (g - 2 * q) / f, y = c.pointWidth, t = r(y) ? (p - y) / 2 : p * c.pointPadding, u = n(y, p - 2 * t), x = za(s(u, 1 + 2 * e)), v = t + (q + ((i ? f - (a.columnIndex || 0) : a.columnIndex) || 0) * p - g / 2) * (i ? -1 : 1), z = a.translatedThreshold = h.getThreshold(c.threshold), w = n(c.minPointLength, 5);
            o(m, function(c) {
        ...
        drawPoints: function() {
            ...
            o(a.points, function(e) {
                ...
                f !== A && !isNaN(f) && e.y !== null ? (d = e.shapeArgs, g ? (fb(g), g.animate(B(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius)) : g && (e.graphic = g.destroy());
            });
        },
        drawTracker: function() {
            for (var a = this, b = a.chart, c = b.renderer, d, e, f = +(new Date), g = a.options, h = (d = g.cursor) && {
                ...
                b.hoverSeries !== a && w(j, "isTracker") !== f && a.onMouseOver();
                l[c.target._i].onMouseOver();
            }, r = function(b) {
                !g.stickyTracking && (j = b.relatedTarget || b.toElement, w(j, "isTracker") !== f) && a.onMouseOut();
        ...
        alignDataLabel: function(a, b, c, d, e) {
            ...
            a.shapeArgs && (d = B(a.shapeArgs), g && (d = {
    ...
    Ca = ba(P, {
        ...
        drawTracker: function() {
            for (var a = this, b = a.options.cursor, b = b && {
                ...
                a.onMouseOver();
                b.target._i !== A && c[b.target._i].onMouseOver();
            ...
            if (d.enabled || this._hasPointLabels) {
                ...
                for (a = p[0][0] && p[0][0].dataLabel && (p[0][0].dataLabel.getBBox().height || 21); u--; ) {
                    ...
                    for (v = 0; v < C; v++) {
                        ...
                        g.moved = !0;
                        q && f && (g = b.connector, h = i ? [ "M", r + (h[6] === "left" ? 5 : -5), t, "C", r, t, 2 * h[2] - h[4], 2 * h[3] - h[5], h[2], h[3], "L", h[4], h[5] ] : [ "M", r + (h[6] === "left" ? 5 : -5), t, "L", h[2], h[3], "L", h[4], h[5] ], g ? (g.animate({
                            d: h
