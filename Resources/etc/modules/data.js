(function(h) {
    ...
    h.extend(m.prototype, {
        ...
        parseTable: function() {
            ...
            b && (typeof b == "string" && (b = document.getElementById(b)), l(b.getElementsByTagName("tr"), function(a, b) {
                ...
                b >= c && b <= g && l(a.childNodes, function(a) {
                    (a.tagName === "TD" || a.tagName === "TH") && i >= f && i <= j && (d[i] || (d[i] = []), d[i][b - c] = a.innerHTML, i += 1);
                });
            }), this.dataFound());
        },
        parseGoogleSpreadsheet: function() {
            ...
            d && jQuery.getJSON("https://spreadsheets.google.com/feeds/cells/" + d + "/" + (b.googleSpreadsheetWorksheet || "od6") + "/public/values?alt=json-in-script&callback=?", function(b) {
                ...
                for (e = 0; e < j; e++) d = b[e], i = Math.max(i, d.gs$cell.col), k = Math.max(k, d.gs$cell.row);
        ...
        parseTypes: function() {
            for (var a = this.columns, b = a.length, d, c, g, f; b--; ) for (d = a[b].length; d--; ) c = a[b][d], g = parseFloat(c), f = this.trim(c), f == g ? (a[b][d] = g, g > 31536000000 ? a[b].isDatetime = !0 : a[b].isNumeric = !0) : (c = this.parseDate(c), b === 0 && typeof c == "number" && !isNaN(c) ? (a[b][d] = c, a[b].isDatetime = !0) : a[b][d] = f);
        },
        dateFormats: {
            "YYYY-mm-dd": {
    ...
    h.wrap(h.Chart.prototype, "init", function(a, b, d) {
        var c = this;
        b && b.data ? h.data(h.extend(b.data, {
            complete: function(g) {
                var f = [];
