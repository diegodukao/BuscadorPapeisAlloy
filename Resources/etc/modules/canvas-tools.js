function RGBColor(m) {
    ...
    for (c = 0; c < d.length; c++) {
        ...
        k && (channels = b(k), this.r = channels[0], this.g = channels[1], this.b = channels[2], this.ok = !0);
    }
    ...
    function m() {
        ...
        a.Property = function(c, d) {
            ...
            this.Time = {
                toMilliseconds: function() {
                    if (!b.hasValue()) return 0;
                    var a = b.value + "";
                    if (a.match(/s$/)) return b.numValue() * 1000;
                    a.match(/ms$/);
                    return b.numValue();
                }
            };
        ...
        a.Font = new function() {
            ...
            this.Parse = function(d) {
                for (var b = {}, d = a.trim(a.compressSpaces(d || "")).split(" "), k = !1, e = !1, f = !1, g = !1, j = "", h = 0; h < d.length; h++) if (!e && c.Styles.indexOf(d[h]) != -1) {
                    d[h] != "inherit" && (b.fontStyle = d[h]);
                    e = !0;
                } else if (!g && c.Variants.indexOf(d[h]) != -1) {
                    d[h] != "inherit" && (b.fontVariant = d[h]);
                    e = g = !0;
                } else if (!f && c.Weights.indexOf(d[h]) != -1) {
                    d[h] != "inherit" && (b.fontWeight = d[h]);
                    e = g = f = !0;
                } else if (k) d[h] != "inherit" && (j += d[h]); else {
                    d[h] != "inherit" && (b.fontSize = d[h].split("/")[0]);
                    e = g = f = k = !0;
                }
                j != "" && (b.fontFamily = j);
                return b;
        ...
        a.Element.RenderedElementBase = function(c) {
            ...
            this.setContext = function(d) {
                if (this.style("fill").Definition.isUrl()) {
                    ...
                    b != null && (d.fillStyle = b);
                } else this.style("fill").hasValue() && (b = this.style("fill"), this.style("fill-opacity").hasValue() && (b = b.Color.addOpacity(this.style("fill-opacity").value)), d.fillStyle = b.value == "none" ? "rgba(0,0,0,0)" : b.value);
                if (this.style("stroke").Definition.isUrl()) {
                    if (b = this.style("stroke").Definition.getFillStyle(this), b != null) d.strokeStyle = b;
                } else this.style("stroke").hasValue() && (b = this.style("stroke"), this.style("stroke-opacity").hasValue() && (b = b.Color.addOpacity(this.style("stroke-opacity").value)), d.strokeStyle = b.value == "none" ? "rgba(0,0,0,0)" : b.value);
                ...
                typeof d.font != "undefined" && (d.font = a.Font.CreateFont(this.style("font-style").value, this.style("font-variant").value, this.style("font-weight").value, this.style("font-size").hasValue() ? this.style("font-size").Length.toPixels() + "px" : "", this.style("font-family").value).toString());
        ...
        a.Element.AnimateBase = function(c) {
            ...
            this.update = function(a) {
                this.initialValue == null && (this.initialValue = this.getProperty().value);
                if (this.duration > this.maxDuration) {
                    if (this.attribute("repeatCount").value != "indefinite") return this.attribute("fill").valueOrDefault("remove") == "remove" && !this.removed ? (this.removed = !0, this.getProperty().value = this.initialValue, !0) : !1;
                    this.duration = 0;
                }
                this.duration += a;
                a = !1;
        ...
        a.Element.font = function(c) {
            ...
            for (c = 0; c < this.children.length; c++) {
                ...
                d.type == "font-face" ? (this.fontFace = d, d.style("font-family").hasValue() && (a.Definitions[d.style("font-family").value] = this)) : d.type == "missing-glyph" ? this.missingGlyph = d : d.type == "glyph" && (d.arabicForm != "" ? (this.isArabic = this.isRTL = !0, typeof this.glyphs[d.unicode] == "undefined" && (this.glyphs[d.unicode] = []), this.glyphs[d.unicode][d.arabicForm] = d) : this.glyphs[d.unicode] = d);
            }
        };
        ...
        a.Element.TextElementBase = function(c) {
            ...
            this.getGlyph = function(a, b, c) {
                ...
                if (a.isArabic) {
                    var g = "isolated";
                    (c == 0 || b[c - 1] == " ") && c < b.length - 2 && b[c + 1] != " " && (g = "terminal");
        ...
        a.Element.a = function(c) {
            ...
            this.base(c);
            this.hasText = !0;
            for (var d = 0; d < c.childNodes.length; d++) c.childNodes[d].nodeType != 3 && (this.hasText = !1);
        ...
        a.loadXmlDoc = function(c, d) {
            ...
            a.opts.ignoreMouse != 1 && (c.canvas.onclick = function(c) {
            ...
            var k = a.CreateElement(d.documentElement), e = k.root = !0, f = function() {
                ...
                if (a.opts.ignoreDimensions != 1) {
                    k.style("width").hasValue() && (c.canvas.width = k.style("width").Length.toPixels("x"), c.canvas.style.width = c.canvas.width + "px");
                    k.style("height").hasValue() && (c.canvas.height = k.style("height").Length.toPixels("y"), c.canvas.style.height = c.canvas.height + "px");
                }
                var b = c.canvas.clientWidth || c.canvas.width, d = c.canvas.clientHeight || c.canvas.height;
                a.ViewPort.SetCurrent(b, d);
                a.opts != null && a.opts.offsetX != null && (k.attribute("x", !0).value = a.opts.offsetX);
                a.opts != null && a.opts.offsetY != null && (k.attribute("y", !0).value = a.opts.offsetY);
                ...
                a.opts.ignoreClear != 1 && c.clearRect(0, 0, b, d);
                k.render(c);
            ...
            a.intervalID = setInterval(function() {
                ...
                a.opts.ignoreMouse != 1 && (b |= a.Mouse.hasEvents());
                if (a.opts.ignoreAnimation != 1) for (var c = 0; c < a.Animations.length; c++) b |= a.Animations[c].update(1000 / a.FRAMERATE);
                a.opts != null && typeof a.opts.forceRedraw == "function" && a.opts.forceRedraw() == 1 && (b = !0);
